...
public class Packets {
	...
	static {
		...
		KRYO.register(LockEntryRequestPacket.class);
		KRYO.register(UnlockEntryRequestPacket.class);
		...
		KRYO.register(LockTagRequestPacket.class);
		KRYO.register(UnlockTagRequestPacket.class);
